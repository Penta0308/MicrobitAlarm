...
// Macros
#define MICROBIT_BLE_ENABLED                     1          // defined by application
#define MICROBIT_BLE_OPEN                        1          // defined by application
#define MICROBIT_BLE_PAIRING_MODE                1          // defined by application
#define MICROBIT_SD_GATT_TABLE_SIZE              0x700      // defined by application
